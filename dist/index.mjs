...
function SvgUri(props) {
  ...
  return /* @__PURE__ */ React.createElement(View, { style: [{ justifyContent: "center", alignItems: "center" }, style, { width, height }] }, renderedSVG.element);
}
...
function createSVGElement(node, children, fill, fillAll, width, height, mode) {
  ...
  switch (node.nodeName) {
    case "svg": {
      ...
      return /* @__PURE__ */ React.createElement(Svg, { key: i, ...componentAtts, style: [componentAtts.style, { transform: [{ scaleX }, { scaleY }] }] }, children);
    }
    case "g":
